...
PAGES_STORAGE_FILESYSTEM_LOCATION = getattr(settings, 'PAGES_STORAGE_FILESYSTEM_LOCATION', settings.MEDIA_ROOT)
PAGES_STORAGE_FILESYSTEM_FILE_PERMISSION_MODE = getattr(settings, 'PAGES_STORAGE_FILESYSTEM_FILE_PERMISSION_MODE', 0644)
